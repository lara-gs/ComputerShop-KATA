...
public class StoreTest {
    ...
    void testGetComputers() {
        Computer computer1 = new Computer(1,"ThinkPad", 8, "Intel i7", "Windows 10", 1500.0);
        Computer computer2 = new Computer(2,"MacBook", 16, "M1", "macOS", 2500.0);
        List<Computer> computers = Arrays.asList(computer1, computer2);
        Store store = new Store(1,"MissingXP", "Travis Gutierrez", 0000123, computers);
    ...
    @Test
    void testGetOwner() {
        Store store = new Store(1,"MissingXP", "Travis Gutierrez", 0000123, null);
    ...
    void testSetComputers() {
        ...
        Computer computer2 = new Computer(2,"MacBook", 16, "M1", "macOS", 2500.0);
        List<Computer> computers = Arrays.asList(computer1, computer2);
        Store store = new Store(3,"MissingXP", "Travis Gutierrez", 0000123, computers);
    ...
    void testAddComputer() {
        Store store = new Store(1,"MissingXP", "Travis Gutierrez", 0000123, null);
        Computer computer = new Computer(1,"HP", 2, "Intel", "Windows 95", 100.00);
    ...
    void testRemoveComputerByBrand() {
        Store store = new Store(1,"MissingXP", "Travis Gutierrez", 0000123, null);
        Computer computer1 = new Computer(1,"HP", 2, "Intel", "Windows 95", 100.00);
        Computer computer2 = new Computer(2,"Dell", 16, "AMD Ryzen 7", "Windows 10", 1800.00);
